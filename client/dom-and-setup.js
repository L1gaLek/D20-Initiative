...
const tavernBoardError = document.getElementById('tavernBoardError');
const tavernBoardHint = document.getElementById('tavernBoardHint');
const tavernCreateAnnouncementBtn = document.getElementById('tavernCreateAnnouncementBtn');
const tavernAdventuresModal = document.getElementById('tavernAdventuresModal');
const tavernAdventuresClose = document.getElementById('tavernAdventuresClose');
const tavernAdventuresList = document.getElementById('tavern-adventures-list');
const tavernAdventuresError = document.getElementById('tavernAdventuresError');
...
const tavernCreateAnnouncementCancel = document.getElementById('tavernCreateAnnouncementCancel');
const tavernCreateAnnouncementSubmit = document.getElementById('tavernCreateAnnouncementSubmit');
const tavernCreateAnnouncementError = document.getElementById('tavernCreateAnnouncementError');
const announcementScenarioInput = document.getElementById('announcementScenarioInput');
const announcementAdventureType = document.getElementById('announcementAdventureType');
const announcementLevelInput = document.getElementById('announcementLevelInput');
const announcementMaxPlayersInput = document.getElementById('announcementMaxPlayersInput');
const announcementNeededPlayersInput = document.getElementById('announcementNeededPlayersInput');
const announcementStartAtInput = document.getElementById('announcementStartAtInput');
const announcementContactInput = document.getElementById('announcementContactInput');
...
const initiativePlayersBox = document.getElementById('initiative-players-box');
const initiativePlayersList = document.getElementById('initiative-players-list');
